 ...
 * Thu Apr 22 2021 01:25:12 GMT+0900 (대한민국 표준시)
...
registerOnHover('side-L', false, function() {
  changeVis('side-L', false);
}, function() {});
...
registerOnClick('side-R', false, false, [0,1,2], function() {
  changeVis('side-R', false);
}, function() {});

registerOnClick('Body378', false, false, [0,1,2], function() {
  setMaterialColor('black', 'Principled BSDF Color', mathRandomInt(0.1, 0.8), mathRandomInt(0.1, 0.8), mathRandomInt(0.1, 0.8), '');
}, function() {});
registerOnClick('CC', false, false, [0,1,2], function() {
  setMaterialColor('black', 'Principled BSDF Color', mathRandomInt(0.1, 0.8), mathRandomInt(0.1, 0.8), mathRandomInt(0.1, 0.8), '');
}, function() {});
registerOnClick('Body379', false, false, [0,1,2], function() {
  setMaterialColor('black', 'Principled BSDF Color', mathRandomInt(0.1, 0.8), mathRandomInt(0.1, 0.8), mathRandomInt(0.1, 0.8), '');
}, function() {});
